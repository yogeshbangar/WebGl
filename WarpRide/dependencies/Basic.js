...
function dealWithKeyboard(e) {
    ...
    switch (e.keyCode) {
        ...
        case 57:
            ...
            break;
        case 54:
            VAL.rx = VAL.ry = VAL.rz = 0;
            break;
    }
    // console.log("sx = " + VAL.sx + ", sy = " + VAL.sy + ", sz =" + VAL.sz);
    // console.log(e.keyCode + " rx = " + VAL.rx + ", ry = " + VAL.ry + ", rz =" + VAL.rz);
}
...
function createColor() {
    clr++;
    var frequency = 0.03;
    let r = Math.floor(Math.sin(frequency * clr + 0) * 127 + 128);
    let g = Math.floor(Math.sin(frequency * clr + 2) * 127 + 128);
    let b = Math.floor(Math.sin(frequency * clr + 4) * 127 + 128);
