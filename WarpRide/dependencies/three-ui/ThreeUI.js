...
ThreeUI.prototype.resize = function () {
	...
	var containerWidth = this.gameCanvas.parentNode.getBoundingClientRect().width * 2;
	console.log(this.width + " this.width " + this.gameCanvas.parentNode.getBoundingClientRect().width);
