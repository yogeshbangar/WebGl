            ...
            if (this.anim > 0) {
                ...
                if (this.anim > 80) {
                    ...
                    if (this.bathit < 9) {
                        ...
                        if (this.bathit == 5) {
                            DrawTexture(mGame.amazone1, 0, -94, 471 * .42, 71 * .42);
                        }
                        else {
                            DrawTexture(mGame.amazone, 0, -94, 140 * .42, 28 * .42);
                        }
...
class Game {
    ...
    init() {
        ...
        AssetLoader.add.image64('TnC_64', TnC_64);
        AssetLoader.add.image64('NEWTXT', NEWTXT);
        ...
        AssetLoader.load(function () {
            ...
            game.amazone = loadUI(game.gameUI, 'TnC_64', 0, 200, 0);
            game.amazone1 = loadUI(game.gameUI, 'NEWTXT', 0, 200, 0);
            game.redC = [];
            game.redG = [];
            game.blueC = [];
            for (let i = 0; i < 6; i++) {
    ...
    setScreen(scr) {
        ...
        this.apply.visible = this.amazone1.visible = this.amazone.visible = false;
        ...
        switch (GameScreen) {
            ...
            case GAMERESULT:
                ...
                DrawLbl(this.mTex_fonts[7], '19 RUNS AND 0 OFFERS', 0, -50, CLR_BLUE, 28);
    ...
    drawResult() {
        ...
        DrawLbl(this.mTex_fonts[9], '' + (ofr > 9 ? 5 : ofr), 25, oy - 70, CLR_RED, 28);
        scl = .42;
        ...
        DrawTexture(this.apply, 90, 260, 435 * (this.mSel == 3 ? .4 : .38), 128 * (this.mSel == 3 ? .4 : .38));
