...
function shaderAdd(game) {
    ...
    game.renderTarget = new THREE.WebGLRenderTarget(window.innerWidth, window.innerHeight);
...
function update(game) {
    ...
    if (game.materialRtt.uniforms["time"].value > 1 || game.materialRtt.uniforms["time"].value < 0) {
        delta *= - 1;
    }
